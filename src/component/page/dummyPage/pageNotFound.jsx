...
const Header_1 = styled.h1`
    font-size: 7.5em;
    margin: 15px 0px;
    font-weight:bold;
`
const Header_2 = styled.h2`
    font-weight:bold;
`
            ...
            <PageNotFoundStyle>
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
                                    ...
                                    <g id="planet">
                                        ...
                                        <circle id="craterBig" fill="none" stroke="#fff" stroke-width="3" stroke-miterlimit="10" cx="548.891"
                                            cy="62.319" r="13.074" />

                                        <circle id="craterSmall" fill="none" stroke="#fff" stroke-width="3" stroke-miterlimit="10" cx="591.743"
                                            cy="158.918" r="7.989" />
                                        <path id="ring" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round"
                                            stroke-miterlimit="10" d="
			M476.562,101.461c-30.404,2.164-49.691,4.221-49.691,8.007c0,6.853,63.166,12.408,141.085,12.408s141.085-5.555,141.085-12.408
			c0-3.378-15.347-4.988-40.243-7.225" />

                                        <path id="ringShadow" opacity="0.5" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round"
                                            stroke-miterlimit="10" d="
                                    ...
                                    <g id="stars">
                                        <g id="starsBig">
                                            <g>
                                                ...
                                                <line fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                        ...
                                        <g id="circlesBig">
                                            ...
                                            <circle fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
